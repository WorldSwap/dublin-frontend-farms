...
const FarmCard: React.FC<FarmCardProps> = ({ farm, removed, cakePrice, bnbPrice, ethereum, account }) => {
  ...
  const farmImage = farm.isTokenOnly ? (
    <img src={`/images/farms/${symbolLower}.png`} alt={symbolLower} width={64} />
  ) : (
    <Flex className="flex space-x-1">
      <img src={`/images/farms/${symbolLower}.png`} alt={symbolLower} width={48} />
      <img
  ...
  return (
    <FCard>
      {farm.tokenSymbol === 'DUB' && <StyledCardAccent />}
      <CardHeading
        lpLabel={lpLabel}
